...
namespace Salary_Calculator
{
    public partial class Salary_Calculator : Form
    {
        ...
        double base_wage = 26829; // Brüt Asgari Ücret * 2 = 13.414,50  * 2 = 26829 TL 
        double min_salary = 0;
        private UserInfo userInfo;
        public event Action<double> SalaryCalculated; // Event to notify salary calculation

        private string receivedValue;
        
        public Salary_Calculator(UserInfo userInfo)
        {
            InitializeComponent();
        ...
        private void calculateBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                coefficient += 0.05 * (double)numericUpDown1.Value; // Foreign language count coefficient
                min_salary = base_wage * coefficient;
                textBoxSalary.Text = min_salary.ToString() + "₺";
                SalaryCalculated?.Invoke(min_salary); // Trigger the event
            }
        }
